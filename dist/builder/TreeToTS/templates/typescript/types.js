  ...
  ? {
    ...
    }[keyof DST] &
      {
        [P in keyof Omit<
          ...
          >,
          '__typename'
        >]: IsPayLoad<DST[P]> extends ${truthy_1.truthyType} ? SRC[P] : IsArray<SRC[P], DST[P]>;
      }
  : {
      [P in keyof Pick<SRC, keyof DST>]: IsPayLoad<DST[P]> extends ${truthy_1.truthyType} ? SRC[P] : IsArray<SRC[P], DST[P]>;
    };
